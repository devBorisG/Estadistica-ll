...
def probabilidad_proporcion_menores(z):
    return float(norm.ppf(z, 0, 1))


def probabilidad_proporcion_mayores(z):
    return 1 - norm.ppf(z, 0, 1)
